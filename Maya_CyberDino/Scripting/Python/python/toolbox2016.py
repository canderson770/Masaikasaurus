...
def create_my_toolbox():
	...
	#Animation Window
	cmds.separator(height=12, parent=tab_1_column)
	custom_outliner_button = cmds.button(parent=tab_1_column, label='Animator', annotation='Open animation master', command=lambda *args: keyframe_functions5.custom_animation())
...
def my_toolbox_window():
    ...
    my_workspace = cmds.workspaceControl(my_workspace, retain=False, floating=False, label='Cody', widthProperty='preferred', initialWidth=160, initialHeight=570, resizeWidth=160, resizeHeight=560, uiScript='create_my_toolbox()')
