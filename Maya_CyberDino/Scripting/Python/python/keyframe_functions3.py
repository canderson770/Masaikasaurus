...
def create_clip_row(custom_animation_column):
    ...
    cmds.menuItem(parent=right_click_menu, label='Normal Key', command=lambda *args: change_key_color(False))
    cmds.menuItem(parent=right_click_menu, label='Special Key', command=lambda *args: change_key_color(True))
    cmds.menuItem(parent=right_click_menu, label='Breakdown Key', command=lambda *args: change_to_breakdown(True))    
